...
const BooksPage = async () => {
    ...
    return (
        <main className="w-full min-h-screen flex flex-col justify-start items-center from-tsBlue-100 to-tsBlue-200">
            <h1 className="mt-28 mb-7 md:mt-24 text-center font-extrabold text-transparent text-6xl bg-clip-text bg-gradient-to-r from-tsWhite-100 to-tsWhite-200">Libros</h1>
