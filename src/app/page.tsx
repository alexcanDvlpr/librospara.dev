...
export default function Home() {
  return (
    <main className="w-full min-h-screen flex flex-col justify-center items-center from-tsBlue-100 to-tsBlue-200">
      <header>
        <h1 className="text-center font-extrabold text-transparent text-5xl sm:text-8xl bg-clip-text bg-gradient-to-r from-tsWhite-100 to-tsWhite-200">#librosParaDevs</h1>
